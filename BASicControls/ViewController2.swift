...
class ViewController2: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Advance Controll2", style: .done, target: self, action: #selector(didTapRegister))
...
//        self.scrollView(scrollView, didScrollToPercentageOffset: percentageHorizontalOffset)
    ...
    @IBAction func JUmpTOnxt(_ sender: Any) {
        let vc2 = self.storyboard?.instantiateViewController(identifier: "ViewController3") as! ViewController3
